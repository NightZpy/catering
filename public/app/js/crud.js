...
},{"./interopRequireDefault.js":2}],2:[function(require,module,exports){
"use strict";
...
},{"./VuetablePaginationMixin.vue":13,"vue":7,"vue-hot-reload-api":4}],11:[function(require,module,exports){
'use strict';
...
},{"./VuetablePaginationMixin.vue":13,"vue":7,"vue-hot-reload-api":4}],12:[function(require,module,exports){
'use strict';
...
},{"./VuetablePaginationMixin.vue":13,"vue":7,"vue-hot-reload-api":4}],13:[function(require,module,exports){
'use strict';
...
},{"../vendor/vue-editable/vue-editable.js":15,"../vendor/vue-strap/vue-strap.min.js":16,"../vendor/vue-table/components/VuetablePaginationSimple.vue":18,"vue":7,"vue-resource":5,"vue-validator":6,"vuetable/src/components/Vuetable.vue":9,"vuetable/src/components/VuetablePagination.vue":10,"vuetable/src/components/VuetablePaginationBootstrap.vue":11,"vuetable/src/components/VuetablePaginationDropdown.vue":12}],15:[function(require,module,exports){
"use strict";
  ...
  return (function (t) {
    ...
    function i(t, e) {
      for (var n = 0; n < t.length; n++) {
        var i = t[n],
            o = f[i.id];if (o) {
          o.refs++;for (var r = 0; r < o.parts.length; r++) o.parts[r](i.parts[r]);for (; r < i.parts.length; r++) o.parts.push(c(i.parts[r], e));
        } else {
          for (var s = [], r = 0; r < i.parts.length; r++) s.push(c(i.parts[r], e));f[i.id] = { id: i.id, refs: 1, parts: s };
        }
      }
    }function o(t) {
      ...
      e = e || {}, "undefined" == typeof e.singleton && (e.singleton = v()), "undefined" == typeof e.insertAt && (e.insertAt = "bottom");var n = o(t);return i(n, e), function (t) {
        for (var r = [], s = 0; s < n.length; s++) {
          ...
          var l = r[s];if (0 === l.refs) {
            for (var u = 0; u < l.parts.length; u++) l.parts[u]();delete f[l.id];
          }
        }
      };
    };var b = (function () {
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = function (t) {
    ...
    "use strict";var i = n(40)(!0);n(43)(String, "String", function (t) {
    ...
    "use strict";var i = n(44),
      ...
      c(n, e, g);var k,
        ...
        if (!f && t in R) return R[t];switch (t) {case v:
          ...
          A = "Array" == e ? R.entries || C : C;if ((A && (M = d(A.call(new t())), M !== Object.prototype && (u(M, S, !0), i || a(M, p) || s(M, p, m))), O && C && C.name !== y && (E = !0, j = function () {
        return C.call(this);
      }), i && !w || !f && !E && R[p] || s(R, p, j), l[e] = j, l[S] = m, x)) if ((k = { values: O ? j : D(y), keys: b ? j : D(v), entries: $ }, w)) for (_ in k) _ in R || r(R, _, k[_]);else o(o.P + o.F * (f || E), e, k);return k;
    };
  }, function (t, e) {
    t.exports = !0;
  }, function (t, e, n) {
    var i = n(46),
      ...
      var c,
          ...
          g = f ? o : o[e] || (o[e] = {}),
          x = g[a],
          b = f ? i : h ? i[e] : (i[e] || {})[a];f && (n = e);for (c in n) u = !p && b && void 0 !== b[c], u && c in g || (d = u ? b[c] : n[c], g[c] = f && "function" != typeof b[c] ? n[c] : y && u ? r(d, i) : m && b[c] == d ? (function (t) {
    ...
    var i = n(52),
      ...
      var t,
          e = n(57)("iframe"),
          i = r.length,
          o = ">";for (e.style.display = "none", n(78).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object</script" + o), t.close(), _c = t.F; i--;) delete _c[l][r[i]];return _c();
    ...
    var i = n(51),
      ...
      o(t);for (var n, s = r(e), a = s.length, l = 0; a > l;) i.f(t, n = s[l++], e[n]);return t;
    };
  }, function (t, e, n) {
    var i = n(67),
    ...
    var i = n(61),
      ...
      var n,
          a = o(t),
          l = 0,
          c = [];for (n in a) n != s && i(a, n) && c.push(n);for (; e.length > l;) i(a, n = e[l++]) && (~r(c, n) || c.push(n));return c;
    };
  }, function (t, e, n) {
    var i = n(69),
        o = n(42);t.exports = function (t) {
    ...
    var i = n(68),
      ...
      return function (e, n, s) {
        ...
        } else for (; c > u; u++) if ((t || u in l) && l[u] === n) return t || u;return !t && -1;
      };
    };
  }, function (t, e, n) {
    var i = n(41),
    ...
    "use strict";var i = n(48),
      ...
      Array.from(t);
        ...
        var e,
            ...
            v = void 0 !== h,
            y = 0,
            m = c(d);if ((v && (h = i(h, f > 2 ? arguments[2] : void 0, 2)), void 0 == m || p == Array && a(m))) for (e = l(d.length), n = new p(e); e > y; y++) n[y] = v ? h(d[y], y) : d[y];else for (u = m.call(d), n = new p(); !(o = u.next()).done; y++) n[y] = v ? s(u, h, [o.value, y], !0) : o.value;return n.length = y, n;
      } });
  }, function (t, e, n) {
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 });var n = { listen: function listen(t, e, n) {
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = { data: function data() {
        ...
        for (var t in this.$parent.$children) if (this.$parent.$children[t].$el == this.$el) {
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = function () {
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = { props: { value: { type: Array, "default": function _default() {
            return [];
    ...
    "use strict";function i(t) {
      return t && t.__esModule ? t : { "default": t };
        ...
        return { weekRange: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], dateRange: [], decadeRange: [], currDate: new Date(), displayDayView: !1, displayMonthView: !1, displayYearView: !1, monthNames: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"] };
          ...
          var t = this;this.dateRange = [], this.decadeRange = [];for (var e = { year: this.currDate.getFullYear(), month: this.currDate.getMonth(), day: this.currDate.getDate() }, n = e.year.toString(), i = n.substring(0, n.length - 1) + 0 - 1, o = 0; 12 > o; o++) this.decadeRange.push({ text: i + o });var r = new Date(e.year, e.month, 1),
          ...
          }, o = 1; a >= o; o++) d(o);if (this.dateRange.length < 42) for (var p = 42 - this.dateRange.length, f = this.getYearMonth(e.year, e.month + 1), o = 1; p >= o; o++) this.dateRange.push({ text: o, date: new Date(f.year, f.month, o), sclass: "datepicker-item-gray" });
        } }, ready: function ready() {
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = { props: { value: { type: String } }, data: function data() {
        return { chosen: !1 };
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = { props: { value: { type: String, twoWay: !0 }, type: { type: String, "default": "default" } } };
  }, function (t, e) {
    t.exports = "<div class=btn-group data-toggle=buttons> <slot></slot> </div>";
  }, function (t, e, n) {
      ...
      return t && t.__esModule ? t : { "default": t };
        ...
        return { searchText: null, show: !1, showNotify: !1 };
          ...
          var t = [];if (this.value.length) {
            for (var e in this.value) "string" == typeof this.value[e] && t.push(this.value[e]);return t.join(", ");
          }
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = { props: { effect: { type: String, "default": "fadein" }, active: { type: Number, "default": 0 } }, data: function data() {
        return { renderData: [] };
    ...
    "use strict";Object.defineProperty(e, "__esModule", { value: !0 }), e["default"] = function (t, e) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\Proyectos\\Webs\\catering\\resources\\assets\\vendor\\vue-table\\components\\VuetablePaginationMixin.vue"
  if (!module.hot.data) {
...
var _VuetablePaginationMixinVue = require('./VuetablePaginationMixin.vue');

var _VuetablePaginationMixinVue2 = _interopRequireDefault(_VuetablePaginationMixinVue);

exports['default'] = {
    mixins: [_VuetablePaginationMixinVue2['default']],
    methods: {
        loadPage: function loadPage(page) {
            this.$dispatch('vuetable-pagination:change-page', page);
        }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\Proyectos\\Webs\\catering\\resources\\assets\\vendor\\vue-table\\components\\VuetablePaginationSimple.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
