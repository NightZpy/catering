<div class="row">
    <div class="col-md-5">
        <div class="form-inline form-group">
            <label>{{ trans('utensils.index.buttons.search') }}</label>
            ...
            <button class="btn btn-default" @click="resetFilter">{{ trans('utensils.index.buttons.reset') }}</button>
        </div>
    </div>
    <div class="col-md-7">
        <div class="dropdown form-inline pull-right">
            <label>{{ trans('utensils.index.labels.pagination-style') }}</label>
...
<div class="table-responsive" id="utensils-table">
    <vuetable v-ref:vuetable
        api-url="{{ route('api.v1.kitchen.utensils.index') }}"
        :fields="columns"
        pagination-path=""
        :fields="fields"
