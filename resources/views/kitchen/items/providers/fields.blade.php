...
<div class="form-group col-sm-6">
    ...
    <input type="text" class="form-control" v-model="row.name" v-validate:name="{ required: true, minlength: 1, maxlength: 128{{-- , unique: items --}} }" data-type="text" />
...
<!-- Unit Id Field -->
<div class="form-group col-sm-6" @click="getForeignData('{{ route('api.v1.units.index') }}/', 'unitOptions')" class="form-group col-sm-6">
...
<div class="form-group col-sm-6" @click="getForeignData('{{ route('api.v1.presentations.index') }}/', 'presentationOptions')" class="form-group col-sm-6">
...
<!-- Type Id Field -->
<div class="form-group col-sm-6" @click="getForeignData('{{ route('api.v1.types.index') }}/', 'typeOptions')" class="form-group col-sm-6">
...
<!-- SubFamily Id Field -->
<div v-if="foreignData.familyOptionsCount > 0" class="form-group col-sm-6" @click="getForeignData('{{ route('api.v1.subFamilies.byFamily') }}/' + row.family_id , 'subFamilyOptions')" class="form-group col-sm-6">
