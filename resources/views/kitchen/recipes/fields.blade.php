...
<div class="form-group col-sm-6">
    ...
    <input type="text" class="form-control" v-model="row.name" v-validate:name="{ required: true, minlength: 1, maxlength: 128{{-- , unique: recipes --}} }" data-type="text" />
...
<div class="form-group col-sm-6">
    <label for="servings_quantity">Cantidad por ración:</label>
...
<div class="form-group col-sm-6"  @click="getForeignData('{{ route('api.v1.kitchen.recipes.types.select-list') }}/', 'typeOptions', 'type')">
	...
	<select v-model="row.type_id" v-validate:type_id="{ required: true }">
