<div class="row">
    <div class="col-md-5">
        <div class="form-inline form-group">
            <label>{{ trans('units.index.buttons.search') }}</label>
            ...
            <button class="btn btn-default" @click="resetFilter">{{ trans('units.index.buttons.reset') }}</button>
        </div>
    </div>
    <div class="col-md-7">
        <div class="dropdown form-inline pull-right">
            <label>{{ trans('units.index.labels.pagination-style') }}</label>
...
<div class="table-responsive" id="units-table">
    <vuetable v-ref:vuetable
        api-url="{{ route('api.v1.units.index') }}"
        :fields="columns"
        pagination-path=""
        :fields="fields"
